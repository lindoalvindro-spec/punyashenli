...
export default function MainBirthdayPage() {
  ...
  const playlist = [
    { id: 1, title: 'Serta Mulia', artist: 'Sal Priadi', duration: '3:10', src: '/Serta Mulia.mp3' },
    { id: 2, title: 'Me Gustas Tu', artist: 'Manu Chao', duration: '3:58', src: '/Me Gustas Tu_spotdown.org.mp3' },
    { id: 3, title: 'On Melancholy Hill', artist: 'Gorillaz', duration: '4:21', src: '/Gorillaz - On Melancholy Hill (Official Video).mp3' },
  ];
